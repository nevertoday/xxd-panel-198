---
name: xxd-panel-198
description: "Create Panel 198 raster artwork: Limited-palette Floating Fashion Collage. Use when the user invokes xxd-panel-198 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-198/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-198-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
